document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, rule) {
      ...
      return messages[rule] || 'Please check this field.';
    }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (isFormValid) {
        const submitBtn = contactForm.querySelector('[type="submit"], button:not([type="button"])');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "לירן שירות ואחזקה למטבחים תעשיתיים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c2011b79-4807-453b-96ed-1fde60a1cbd6',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c2011b79-4807-453b-96ed-1fde60a1cbd6';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c2011b79-4807-453b-96ed-1fde60a1cbd6';
